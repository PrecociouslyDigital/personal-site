...
- Github Actions
    - Like two weeks after I finished writing the CircleCI config, Github publicially
    released [Github Actions](https://github.com/features/actions), a CI/CD framework that
    seems to just work better, provided you work on Github. I'll probably switch the CI/
    CD Configuration to use Github Actions at some point.
