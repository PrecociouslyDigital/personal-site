...
- Sidenotes
    ...
    - No one really has written a component to do all that stuff[^well actually], probably
    for the reasons described.
            - [John D Jameson's approach](https://johndjameson.com/blog/responsive-sidenotes/)
            is pretty much what I had in mind. There are caveats though.
- Navbar
...
[^well actually]: Okay, technically not true, some guy at Full Stack University[^Spoiler: not an actual university] made a [sidenotes implementation](https://www.fullstackacademy.com/hackathon-presentations/sidenotes) during a hackathon but it's *NOT ON NPM* and *I CAN'T FIND IT ANYWHERE* 