...
<Abstract>
	...
	Skyedelaciel was built with [react-static](https://github.com/react-static/react-static), a static site generator built around React.
	It also makes heavy use of the [MDX](http://mdxjs.com/) plugin for react-static so
	pages can be written in markdown and focus on content instead of scaffolding.
	Styling is done with Fomantic UI, since I am Bad at CSS.
</Abstract>
...
<script type="text/javascript">
        window.__routeInfo = JSON.parse("{\"template\":\"/home/fellfromatree/workbench/site/src/pages/index.tsx\",\"sharedHashesByProp\":{},\"data\":{},\"path\":\"/\",\"sharedData\":{},\"siteData\":{}}");
    </script>
    <script defer="" type="text/javascript" src="/templates/vendors~home/fellfromatree/workbench/site/src/pages/about.mdx~home/fellfromatree/workbench/site/src/~4933c0e9.c9c92bfa.js"></script>
    <script defer="" type="text/javascript" src="/templates/home/fellfromatree/workbench/site/src/pages/index.tsx.2a5a042a.js"></script>
...
[^1]: Under the hood, MDX uses [remark](https://remark.js.org/) and 
[rehype](https://github.com/rehypejs/rehype), both part of the 
unified.js collective](https://unifiedjs.com/) to transpile markdown to JSX. This
lets us also take advantage of the broad ecosystem of plugins around these tools
to provide stuff like [syntax highlighting](https://github.com/mapbox/rehype-prism) or
[latex blocks](https://github.com/remarkjs/remark-math/tree/master/packages/remark-math).
...
[^2]: The original maintainer of Semantic UI ended up unable to actively maintain the
project [due to work commitments](https://github.com/Semantic-Org/Semantic-UI/issues/6109#issuecomment-361104864) (Honestly the most valid). Fomantic UI is a
community fork to continue development, with the intention of being merged back into 
Semantic UI at a later date. 
...
[^3]: I realize that I'm giving out a lot of details about my probably very vulnerable
personal server, and if I get hacked it will only be my own fault. If you are a console
cowboy surfing the reaches of cyberspace and notice anything vulnerable about anything
on `hyphen-emdash.com`, please drop me a note at [skye@hyphen-emdash.com](mailto:skye@hyphen-emdash.com)
so I can fix it. Or hack my server and use it to impersonate me and mine bitcoin (please
